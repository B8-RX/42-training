...
int	check_images_ext(char *extention)
{
	int		i;
	char	*img_ext;
	...
	while (++i < 20)
	{
		...
		if (ft_strncmp(img_ext, extention, 3))
		{
...
{
	if (!game -> img_data.rock_y_top || !game -> img_data.rock_x_left || !game -> img_data.rock_x_right || !game -> img_data.rock_y_bottom || !game -> img_data.rock_y_bottom_left || !game -> img_data.rock_y_bottom_right || !game -> img_data.rock_x_left || !game -> img_data.rock_x_right || !game -> img_data.rock_obstacles || !game -> img_data.sea || !game -> img_data.boat_left || !game -> img_data.boat_up || !game -> img_data.boat_right || !game -> img_data.boat_down || !game -> img_data.boat_left_hit || !game -> img_data.boat_up_hit || !game -> img_data.boat_right_hit || !game -> img_data.boat_down_hit || !game -> img_data.placeholder || !game -> img_data.exit_img || !game -> img_data.fish_img[0] || !game -> img_data.fish_img[1] || !game -> img_data.fish_img[2] || !game -> img_data.fish_img[3])
